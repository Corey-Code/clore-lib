...
describe('TransactionBuilder', function () {
  ...
  describe('fromTransaction', function () {
    ...
    fixtures.zcash.valid.forEach(function (testData) {
      it(
        'returns TransactionBuilder, with ' + testData.description,
        function () {
          ...
          assert.equal(
            txb.tx.joinsplitPubkey.length,
            testData.joinsplitPubkeyLength
          );
      ...
      it(
        'throws if transaction builder network is incompatible for ' +
